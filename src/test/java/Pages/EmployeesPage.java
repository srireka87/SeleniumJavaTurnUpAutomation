...
public class EmployeesPage extends Wait
    {
        public void CreateEmployees(WebDriver driver) throws InterruptedException {
            ...
            employeeNameTextBox.sendKeys("Mann");

            //Enter Username
            WebElement employeeUserNameTextBox = driver.findElement(By.id("Username"));
            employeeUserNameTextBox.sendKeys("Mann");
            ...
            firstNameEditContactTextBox.sendKeys("Kenry");
        ...
        public void CreateEmployeeValidation(WebDriver driver)
        {
            ...
            Assert.assertEquals(actualCreateEmployeeData.getText(), "Mann", "New Employee record was Unsuccessful");
            }
        public void EditEmployees(WebDriver driver) {
            ...
            employeeNameTextBox.sendKeys("Kelly");

            //Enter EditUsername
            WebElement employeeUserNameTextBox = driver.findElement(By.id("Username"));
            employeeUserNameTextBox.clear();
            employeeUserNameTextBox.sendKeys("Kelly");
            ...
            firstNameEditContactTextBox.sendKeys("Kelly");
    ...
    public void EditEmployeeValidataion(WebDriver driver)
        {
            ...
            Assert.assertEquals(afterEditingActualData.getText(),"Kelly", "Actual Employee Edited Data and Expected Edited Data are not matching");
        }
        ...
        public void DeleteEmployeeValidation(WebDriver driver)
        {
           // Validation
            WebElement deleteActualData =driver.findElement(By.xpath("//*[@id=\"usersGrid\"]/div[3]/table/tbody/tr[last()]/td[1]"));
            Assert.assertEquals(deleteActualData.getText(),"Kelly","Expected Employee Records undeleted");
        } 
    }
